...
func TestConversion(t *testing.T) {
	...
	ast.Equal(c2.ZoomOut().ToString(0), "3200")
	...
	ast.Equal(Sc().ZoomIn(1139).ToString(0), "11")
	ast.Equal(Sc().ZoomIn(0.05).ToString(0), "0")
	ast.Equal(Sc().ZoomIn(1139).ToString(3), "11.390")
	ast.Equal(Sc().ZoomIn(0.05).ToString(4), "0.0005")
	ast.Equal(Sc().ZoomIn(1139).ToFloat64(), 11.39)
	ast.Equal(Sc().ZoomIn("1139").ToFloat64(), 11.39)
	ast.Equal(Sc().ZoomIn(1139.11).ToFloat64(), 11.3911)
	ast.Equal(Sc().ZoomIn(1139.00).ToFloat64(), 11.39)
	ast.Equal(Sc().ZoomIn(1139).ToInt(), 11)
	ast.Equal(Sc().ZoomIn("1139").ToInt(), 11)
	ast.Equal(Sc().ZoomIn(1139.11).ToInt(), 11)
	ast.Equal(Sc().ZoomIn(1139.00).ToInt(), 11)
